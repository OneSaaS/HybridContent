...
/**
 * Servlet responsible for serving assets to the caller.  This is basically completely taken from
...
class AssetServlet extends HttpServlet {
    ...
    public AssetServlet(String resourcePath, CacheBuilderSpec spec, String uriPath, String indexFile,
        ...
        try {
            ...
            //TODO How do we stop starting up dropwizard from here?
            e.printStackTrace();
        }
    }
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        try {
            ...
            try {
                ...
                try {
                    String destination = serviceBaseURL + req.getRequestURI().substring(1);
                ...
                resp.sendRedirect(URI_PERMISSION_DENIED.toString());
                return;
            } catch(Throwable t) {
                resp.sendError(HttpServletResponse.SC_INTERNAL_SERVER_ERROR);
                return;
